<template>
	<div class="data-article-recom-page">
        <div class="header">
            <el-row :gutter="20">
...
<script type="text/ecmascript-6">
    ...
    import '../../../css/data/recom/article-recom.less';
    ...
    import {
        ...
        GET_TABLEDATA,
		RECOM_ARTICLE
    } from '../../../vuex/modules/data/recom/article-recom';
    ...
    export default {
        ...
        computed: {
            ...
            ...mapState({
                ...
                sortList: state => state.dataArticleRecom.sortList,
                classify: state => state.dataArticleRecom.classify,
                startTime: state => state.dataArticleRecom.startTime,
                endTime: state => state.dataArticleRecom.endTime,
				seq: state => state.dataArticleRecom.seq,
				desc: state => state.dataArticleRecom.desc,
                tableCount: state => state.dataArticleRecom.tableCount,
                tablePage: state => state.dataArticleRecom.tablePage,
                tableData: state => state.dataArticleRecom.tableData,
            }),
            // 分类切换事件
            classifyValue: {
        ...
        methods: {
			...
			recomChangeHandle(row) {
				let self = this;
				self.$store.dispatch(RECOM_ARTICLE, {
					'id' : row.Article_ID,
