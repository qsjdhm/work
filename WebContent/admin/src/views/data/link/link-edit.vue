...
<script type="text/ecmascript-6">
    ...
    import '../../../css/data/link/link-edit.less';
    ...
    import {
        ...
        GET_TABLEDATACOUNT,
        GET_TABLEDATA
    } from '../../../vuex/modules/data/link/link-edit';
    ...
    export default {
        ...
        computed: {
            ...
            ...mapState({
                ...
                name: state => state.dataLinkEdit.name,
				seq: state => state.dataLinkEdit.seq,
				desc: state => state.dataLinkEdit.desc,
                tableCount: state => state.dataLinkEdit.tableCount,
                tablePage: state => state.dataLinkEdit.tablePage,
                tableData: state => state.dataLinkEdit.tableData,
            }),
			// 名称切换事件
			nameValue: {
