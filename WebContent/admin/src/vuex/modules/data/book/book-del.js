...
export const SET_SORTLIST = 'data-book-del/SET_SORTLIST';
export const SET_CLASSIFY = 'data-book-del/SET_CLASSIFY';
export const SET_NAME = 'data-book-del/SET_NAME';  // 名称
export const SET_SEQ = 'data-book-del/SET_SEQ';  // 排序字段
export const SET_DESC = 'data-book-del/SET_DESC';  // 排序规则

export const SET_TABLECOUNT = 'data-book-del/SET_TABLECOUNT';  // 当前表格数据总数
export const SET_TABLEPAGE = 'data-book-del/SET_TABLEPAGE';  // 当前表格当前页数
export const SET_TABLEDATA = 'data-book-del/SET_TABLEDATA';  // 当前表格当前数据

export const GET_SORTLIST = 'data-book-del/GET_SORTLIST';  // 获取分类列表
export const GET_TABLEDATACOUNT = 'data-book-del/GET_TABLEDATACOUNT';  // 根据根据父分类、子分类、时间区间获取表格数据总数--用来设置page
export const GET_TABLEDATA = 'data-book-del/GET_TABLEDATA';  // 根据根据子分类、时间区间获取表格数据--用来设置表格
export const DEL_BOOK = 'data-book-del/DEL_BOOK';  // 删除图书
...
const actions = {
    ...
    // 删除图书
    [DEL_BOOK] (context, payload) {
        return new Promise((resolve, reject) => {
            Vue.http.post(context.rootState.BASE_URL + '/bookAction/delBook', {
                selectId : payload
            }, {
                headers: {
                    "X-Requested-With": "XMLHttpRequest"
