...
export const SET_SORTLIST = 'data-article-details/SET_SORTLIST';
export const SET_CLASSIFY = 'data-article-details/SET_CLASSIFY';
export const SET_ID = 'data-article-details/SET_ID';
export const SET_NAME = 'data-article-details/SET_NAME';
export const SET_CONTENT = 'data-article-details/SET_CONTENT';
export const SET_TAGLIST = 'data-article-details/SET_TAGLIST';
export const SET_TAG = 'data-article-details/SET_TAG';
export const SET_ISSUBMIT = 'data-article-details/SET_ISSUBMIT';

export const GET_SORTLIST = 'data-article-details/GET_SORTLIST';
export const GET_TAGLIST = 'data-article-details/GET_TAGLIST';
export const GET_ARTICLE = 'data-article-details/GET_ARTICLE';

export const SUBMIT_DATA = 'data-article-details/SUBMIT_DATA';
...
const actions = {
    ...
    [SUBMIT_DATA] (context, payload) {
        return new Promise((resolve, reject) => {
            ...
            Vue.http.post(context.rootState.BASE_URL + '/articleAction/updateArticle', {
                // 参数部分
				"id"       : context.state.id,
