...
export const SET_CLASSIFY = 'data-classify-del/SET_CLASSIFY';
export const SET_NAME = 'data-classify-del/SET_NAME';  // 名称
export const SET_SEQ = 'data-classify-del/SET_SEQ';  // 排序字段
export const SET_DESC = 'data-classify-del/SET_DESC';  // 排序规则

export const SET_TABLECOUNT = 'data-classify-del/SET_TABLECOUNT';  // 当前表格数据总数
export const SET_TABLEPAGE = 'data-classify-del/SET_TABLEPAGE';  // 当前表格当前页数
export const SET_TABLEDATA = 'data-classify-del/SET_TABLEDATA';  // 当前表格当前数据

export const GET_TABLEDATACOUNT = 'data-classify-del/GET_TABLEDATACOUNT';  // 根据根据父分类、子分类、时间区间获取表格数据总数--用来设置page
export const GET_TABLEDATA = 'data-classify-del/GET_TABLEDATA';  // 根据根据子分类、时间区间获取表格数据--用来设置表格
export const DEL_CLASSIFY = 'data-classify-del/DEL_CLASSIFY';  // 删除分类
...
const actions = {
    ...
    // 删除分类
    [DEL_CLASSIFY] (context, payload) {
        return new Promise((resolve, reject) => {
            Vue.http.post(context.rootState.BASE_URL + '/sortAction/delSort', {
                selectId : payload
            }, {
                headers: {
                    "X-Requested-With": "XMLHttpRequest"
