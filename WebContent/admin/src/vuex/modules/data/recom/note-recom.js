...
export const SET_SORTLIST = 'data-note-recom/SET_SORTLIST';
export const SET_CLASSIFY = 'data-note-recom/SET_CLASSIFY';
export const SET_STARTTIME = 'data-note-recom/SET_STARTTIME';  // 起始日期
export const SET_ENDTIME = 'data-note-recom/SET_ENDTIME';  // 结束日期
export const SET_SEQ = 'data-note-recom/SET_SEQ';  // 排序字段
export const SET_DESC = 'data-note-recom/SET_DESC';  // 排序规则

export const SET_TABLECOUNT = 'data-note-recom/SET_TABLECOUNT';  // 当前表格数据总数
export const SET_TABLEPAGE = 'data-note-recom/SET_TABLEPAGE';  // 当前表格当前页数
export const SET_TABLEDATA = 'data-note-recom/SET_TABLEDATA';  // 当前表格当前数据

export const GET_SORTLIST = 'data-note-recom/GET_SORTLIST';  // 获取分类列表
export const GET_TABLEDATACOUNT = 'data-note-recom/GET_TABLEDATACOUNT';  // 根据根据父分类、子分类、时间区间获取表格数据总数--用来设置page
export const GET_TABLEDATA = 'data-note-recom/GET_TABLEDATA';  // 根据根据子分类、时间区间获取表格数据--用来设置表格
export const RECOM_NOTE = 'data-note-recom/RECOM_NOTE';  // 推荐笔记
...
const actions = {
    ...
    [GET_TABLEDATACOUNT] (context, payload) {
        return new Promise((resolve, reject) => {
            ...
            Vue.http.post(context.rootState.BASE_URL + '/noteAction/getNoteCount', {
    ...
    [GET_TABLEDATA] (context, payload) {
        return new Promise((resolve, reject) => {
            Vue.http.post(context.rootState.BASE_URL + '/noteAction/getNoteList', {
                sort : context.state.classify,
                start: context.state.startTime,
                end  : context.state.endTime,
	...
	// 推荐笔记
	[RECOM_NOTE] (context, payload) {
		return new Promise((resolve, reject) => {
			Vue.http.post(context.rootState.BASE_URL + '/recommendAction/recommendNote', {
				id : payload.id,
				recommendNum: payload.recommendNum,
