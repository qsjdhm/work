...
export const SET_SORTLIST = 'data-article-recom/SET_SORTLIST';
export const SET_CLASSIFY = 'data-article-recom/SET_CLASSIFY';
export const SET_STARTTIME = 'data-article-recom/SET_STARTTIME';  // 起始日期
export const SET_ENDTIME = 'data-article-recom/SET_ENDTIME';  // 结束日期
export const SET_SEQ = 'data-article-recom/SET_SEQ';  // 排序字段
export const SET_DESC = 'data-article-recom/SET_DESC';  // 排序规则

export const SET_TABLECOUNT = 'data-article-recom/SET_TABLECOUNT';  // 当前表格数据总数
export const SET_TABLEPAGE = 'data-article-recom/SET_TABLEPAGE';  // 当前表格当前页数
export const SET_TABLEDATA = 'data-article-recom/SET_TABLEDATA';  // 当前表格当前数据

export const GET_SORTLIST = 'data-article-recom/GET_SORTLIST';  // 获取分类列表
export const GET_TABLEDATACOUNT = 'data-article-recom/GET_TABLEDATACOUNT';  // 根据根据父分类、子分类、时间区间获取表格数据总数--用来设置page
export const GET_TABLEDATA = 'data-article-recom/GET_TABLEDATA';  // 根据根据子分类、时间区间获取表格数据--用来设置表格
export const RECOM_ARTICLE = 'data-article-recom/RECOM_ARTICLE';  // 推荐文章
...
const actions = {
    ...
    // 推荐文章
    [RECOM_ARTICLE] (context, payload) {
        return new Promise((resolve, reject) => {
            Vue.http.post(context.rootState.BASE_URL + '/recommendAction/recommendArticle', {
				id : payload.id,
