...
export const SET_NAME = 'data-link-edit/SET_NAME';
export const SET_SEQ = 'data-link-edit/SET_SEQ';  // 排序字段
export const SET_DESC = 'data-link-edit/SET_DESC';  // 排序规则

export const SET_TABLECOUNT = 'data-link-edit/SET_TABLECOUNT';  // 当前表格数据总数
export const SET_TABLEPAGE = 'data-link-edit/SET_TABLEPAGE';  // 当前表格当前页数
export const SET_TABLEDATA = 'data-link-edit/SET_TABLEDATA';  // 当前表格当前数据

export const GET_TABLEDATACOUNT = 'data-link-edit/GET_TABLEDATACOUNT';  // 根据根据父分类、子分类、时间区间获取表格数据总数--用来设置page
export const GET_TABLEDATA = 'data-link-edit/GET_TABLEDATA';  // 根据根据子分类、时间区间获取表格数据--用来设置表格
